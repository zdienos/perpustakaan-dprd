<div class="container mb-5">
	<div class="row">
				...
				<div class="card-body">
					...
					<div class="content">
						...
						<dl class="row">
							...
							<dd class="col-sm-9"><?php echo $kontak->email ?></dd>

							<dt class="col-sm-3">Phone</dt>
							<dd class="col-sm-9"><?php echo $kontak->phone ?></dd>

							<dt class="col-sm-3">Fax</dt>
							<dd class="col-sm-9"><?php echo $kontak->fax ?></dd>
		...
		<div class="col-8">
			<?php echo $kontak->googlemap_iframe ?>
		</div>
		<!-- <div class="col">
