	...
	<div class="row mb-4">
		<div class="col-md-3">
			<div class="card">
				...
				<?php if($catalog->pdf_file): ?>
				<div class="card-body">
					<?php if($this->session->has_userdata('perpustakaan_member')): ?>
						<p><a href="<?php echo base_url('page/katalog_pdf/'. $catalog->id) ?>" target="_blank" class="btn btn-danger btn-block"><i class="fa fa-file-pdf-o"></i> Baca PDF</a></p>
					<?php else: ?>
						<p><a href="<?php echo base_url('page/member_login') ?>" target="_blank" class="btn btn-danger btn-block"><i class="fa fa-file-pdf-o"></i> Baca PDF</a></p>
					<?php endif; ?>
				</div>
			<?php endif; ?>
			</div>
			...
			<div class="card">
				<div class="card-body">
					...
					<dl class="row">
						...
						<dd class="col-sm-9"><?php echo $catalog->edition ?></dd>

						<dt class="col-sm-3">Detail</dt>
						<dd class="col-sm-9">
							<?php echo $catalog->detail ? $catalog->detail : 'Tidak ada detail penjelasan' ?>
						</dd>

						<dt class="col-sm-3">ISBN</dt>
						<dd class="col-sm-9">
							<?php echo $catalog->isbn ?>
						</dd>

						<dt class="col-sm-3">Bahasa</dt>
						<dd class="col-sm-9">
							<?php echo $catalog->language ? $catalog->language : 'Tidak di ketahui' ?>
						</dd>

						<dt class="col-sm-3">Tahun Publikasi</dt>
						<dd class="col-sm-9">
							<?php echo $catalog->publication_year ?>
						</dd>

						<dt class="col-sm-3">Penulis</dt>
						<dd class="col-sm-9">
							<?php echo $catalog->author ? $catalog->author : 'Tidak di ketahui' ?>
						</dd>

						<dt class="col-sm-3">Penerbit</dt>
						<dd class="col-sm-9">
							<?php echo $catalog->publisher ? $catalog->publisher : 'Tidak di ketahui' ?>
						</dd>
