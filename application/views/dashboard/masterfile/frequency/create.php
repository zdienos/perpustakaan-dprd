...
<div class="card" style="border-radius: 0; border: none;">
	<div class="card-header">
		<h5 class="mb-0">Tambah Kala Terbit</h5>
	</div>
	<div class="card-body">
		<form action="<?php echo base_url('dashboard/masterfile/frequency/store') ?>" method="post">
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="number" class="form-control" id="timeincrement" name="timeincrement" value="<?php echo set_value('timeincrement') ?>">
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<select name="timeunit" id="timeunit" class="form-control">
						<option <?php echo set_select('timeunit', 'day') ?> value="day">Hari</option>
						<option <?php echo set_select('timeunit', 'week') ?> value="week">Minggu</option>
						<option <?php echo set_select('timeunit', 'month') ?> value="month">Bulan</option>
						<option <?php echo set_select('timeunit', 'year') ?> value="year">Tahun</option>
					</select>
