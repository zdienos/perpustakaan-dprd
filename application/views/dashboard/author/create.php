	...
	<div class="row">
		<div class="col-md-8 offset-md-2">
			<div class="card border-light">
				...
				<div class="card-body">
					<form action="<?php echo base_url('dashboard/author/store') ?>" method="post">
						...
						<div class="form-group">
							...
							<textarea rows="10" class="form-control" id="biography" name="biography" placeholder="Biography"><?php echo set_value('biography') ?></textarea>
